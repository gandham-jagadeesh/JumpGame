(() => {
  ...
  var fi = (s, t, c) => t in s ? Rn(s, t, { enumerable: true, configurable: true, writable: true, value: c }) : s[t] = c;
  var o = (s, t) => Rn(s, "name", { value: t, configurable: true });
  var mi = (s, t) => {
    for (var c in t)
  ...
  var Or = o((s) => {
    ...
    function ft() {
      ...
      for (let d of t.gamepads) {
        let b = navigator.getGamepads()[d.index], ee = (s.gamepads ?? {})[b.id] ?? Nn[b.id] ?? Nn.default, re = t.gamepadStates.get(d.index);
...
`;
  ...
  var po = o((s = {}) => {
    ...
    o(Ge, "FrameBuffer");
    let w = (() => {
      let e = ft(_n, Hn), n = K.fromImage(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)), r = s.width && s.height ? new Ge(s.width * I, s.height * I) : new Ge(h.drawingBufferWidth / g, h.drawingBufferHeight / g), i = null, u = 1;
    ...
    function dt(e, n = {}) {
      ...
      return { set paused(O) {
        ...
        u.buffer?.duration && (O > u.buffer.duration || (i ? (u = $(u), f = p - O) : (u.stop(), u = $(u), f = r.currentTime - O, u.start(0, O), x = true, p = 0)));
      }, set speed(O) {
    ...
    function ft(e = _n, n = Hn) {
      let r = Mi.replace("{{user}}", e ?? _n), i = Di.replace("{{user}}", n ?? Hn), u = h.createShader(h.VERTEX_SHADER), l = h.createShader(h.FRAGMENT_SHADER);
...
`)
    ...
    let se = { inspect: false, timeScale: 1, showLog: true, fps: () => U.fps(), numFrames: () => U.numFrames(), stepFrame: cr, drawCalls: () => w.drawCalls, clearLog: () => T.logs = [], log: (e) => {
      ...
      T.logs.unshift(`${`[time]${U.time().toFixed(2)}[/time] `}[${r}]${e?.toString ? e.toString() : e}[/${r}]`), T.logs.length > n && (T.logs = T.logs.slice(0, n));
    ...
    function vn(e) {
      let n = /* @__PURE__ */ new Map(), r = {}, i = new De(), u = null, l = { id: Ar(), hidden: false, paused: false, transform: new J(), children: [], parent: null, add(a) {
        ...
        let f = m.recursive ? this.children.flatMap(o(function p(x) {
    ...
    function js(e, n = {}) {
      ...
      return { id: "lifespan", async add() {
        await gt(e), r > 0 && this.opacity && await Tn(this.opacity, 0, r, (i) => this.opacity = i, ot.linear), this.destroy();
      } };
    }
    o(js, "lifespan");
    function Ns(e, n, r) {
    ...
    function Ks(e, n) {
      ...
      let r = bt([Nt(n.pos ?? S(0))]), i = e.length, u = 0, l = null, a = null, m = null, f = null, p = o((y) => y.x + y.y * u, "tile2Hash"), x = o((y) => S(Math.floor(y % u), Math.floor(y / u)), "hash2Tile"), D = o(() => {
        ...
        if (f[G] != -1 && f[G] !== f[N])
          return null;
        let Y = new Ut((Le, On) => Le.cost < On.cost);
    ...
    function ni(e, n = {}) {
      ...
      r.add([En(ti), kt(0), Un("center"), ur(i, u), ...n.comps ?? []]);
      let l = r.add([En(ei), kt(0), Un("center"), nr(), ...n.comps ?? []]);
    ...
    function Cn(e) {
      U.run(() => {
        Ve(() => {
          ...
          ze(a), Jn({ ...l, text: e.message, pos: S(32, 32 + a.height + 16), fixed: true }), V(), T.events.trigger("error", e);
        });
      });
    }
    o(Cn, "handleErr");
